...
public enum OperationalFailureGuide {
    ...
    public static let scenarioCatalog: [OperationalRecoveryAdvice] = [
        ...
        scenario(
            ...
            commands: ["mt5research startcheck --config-dir Config --migrations-dir Migrations"]
        ),
        scenario(
            code: "DB-003",
            ...
            commands: ["mt5research migrate --config-dir Config --migrations-dir Migrations"]
        ),
        scenario(
            code: "MT5-001",
            ...
            commands: ["mt5research startcheck --config-dir Config --migrations-dir Migrations", "lsof -nP -iTCP:5055"]
        ),
        scenario(
            code: "MT5-002",
            ...
            commands: ["mt5research supervise --config-dir Config"]
        ),
        scenario(
            code: "MT5-003",
            ...
            commands: ["mt5research startcheck --config-dir Config --migrations-dir Migrations --skip-bridge"]
        ),
        scenario(
            code: "MT5-004",
            ...
            commands: ["mt5research symbol-check --config-dir Config", "mt5research backfill --config-dir Config --symbols all"]
        ),
        scenario(
            code: "MT5-005",
            ...
            commands: ["mt5research startcheck --config-dir Config --migrations-dir Migrations --skip-bridge --compile-timeout-seconds 180"]
        ),
        scenario(
            code: "TIME-001",
        ...
        scenario(
            ...
            commands: ["mt5research bridge-check --config-dir Config"]
        ),
        scenario(
            code: "TIME-003",
        ...
        scenario(
            ...
            commands: ["mt5research symbol-check --config-dir Config"]
        ),
        scenario(
            code: "DATA-002",
            ...
            commands: ["mt5research verify --config-dir Config --random-ranges 0"]
        ),
        scenario(
            code: "DATA-003",
            ...
            commands: ["mt5research verify --config-dir Config --random-ranges 20"]
        ),
        scenario(
            code: "STATE-001",
            ...
            commands: ["mt5research backfill --config-dir Config --symbols all"]
        ),
        scenario(
            code: "STATE-002",
            ...
            commands: ["mt5research bridge-check --config-dir Config", "mt5research startcheck --config-dir Config --migrations-dir Migrations"]
        ),
        scenario(
            code: "STATE-003",
        ...
        scenario(
            ...
            commands: ["mt5research repair --config-dir Config --symbol EURUSD --from 2020-01-01 --to 2020-02-01"]
        ),
        scenario(
            code: "BACKTEST-001",
        ...
        scenario(
            ...
            commands: ["ps aux | grep mt5research"]
        ),
        scenario(
            code: "OS-001",
            ...
            commands: ["df -h", "brew services restart clickhouse", "mt5research startcheck --config-dir Config --migrations-dir Migrations"]
        ),
        scenario(
            code: "OS-002",
            ...
            commands: ["mt5research startcheck --config-dir Config --migrations-dir Migrations", "mt5research backfill --config-dir Config --symbols all", "mt5research supervise --config-dir Config --with-backfill"]
        )
    ]
    ...
    private static func unknownAdvice(_ error: Error) -> OperationalRecoveryAdvice {
        scenario(
            ...
            commands: [
                "mt5research startcheck --config-dir Config --migrations-dir Migrations",
                "mt5research verify --config-dir Config --random-ranges 0"
            ]
        )
    }
