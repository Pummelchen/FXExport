...
public enum OperationalFailureGuide {
    ...
    public static let scenarioCatalog: [OperationalRecoveryAdvice] = [
        ...
        scenario(
            ...
            commands: ["startcheck --config-dir Config --migrations-dir Migrations"]
        ),
        scenario(
            code: "DB-003",
            ...
            commands: ["migrate --config-dir Config --migrations-dir Migrations"]
        ),
        scenario(
            code: "MT5-001",
            title: "MT5 bridge not connected",
            summary: "Swift could not accept/connect the localhost TCP bridge.",
            automaticRecovery: "The supervisor retries connection on later cycles; interactive commands print exact EA/port steps.",
            ...
            commands: ["startcheck --config-dir Config --migrations-dir Migrations", "lsof -nP -iTCP:5055"]
        ),
        scenario(
            code: "MT5-002",
            ...
            commands: ["supervise --config-dir Config"]
        ),
        scenario(
            code: "MT5-003",
            ...
            commands: ["startcheck --config-dir Config --migrations-dir Migrations --skip-bridge"]
        ),
        scenario(
            code: "MT5-004",
            ...
            commands: ["symbol-check --config-dir Config", "backfill --config-dir Config --symbols all"]
        ),
        scenario(
            code: "MT5-005",
            ...
            commands: ["startcheck --config-dir Config --migrations-dir Migrations --skip-bridge --compile-timeout-seconds 180"]
        ),
        scenario(
            code: "TIME-001",
        ...
        scenario(
            ...
            commands: ["bridge-check --config-dir Config"]
        ),
        scenario(
            code: "TIME-003",
        ...
        scenario(
            ...
            commands: ["symbol-check --config-dir Config"]
        ),
        scenario(
            code: "DATA-002",
            ...
            commands: ["verify --config-dir Config --random-ranges 0"]
        ),
        scenario(
            code: "DATA-003",
            ...
            commands: ["verify --config-dir Config --random-ranges 20"]
        ),
        scenario(
            code: "STATE-001",
            ...
            commands: ["backfill --config-dir Config --symbols all"]
        ),
        scenario(
            code: "STATE-002",
            ...
            commands: ["bridge-check --config-dir Config", "startcheck --config-dir Config --migrations-dir Migrations"]
        ),
        scenario(
            code: "STATE-003",
        ...
        scenario(
            ...
            commands: ["repair --config-dir Config --symbol EURUSD --from 2020-01-01 --to 2020-02-01"]
        ),
        scenario(
            code: "BACKTEST-001",
            ...
            commands: ["supervise --config-dir Config --supervisor-cycles 1", "verify --config-dir Config --random-ranges 20"]
        ),
        scenario(
            code: "LOG-001",
            ...
            commands: ["mkdir -p Logs", "df -h", "startcheck --config-dir Config --migrations-dir Migrations --skip-bridge"]
        ),
        scenario(
            code: "CONFIG-001",
        ...
        scenario(
            ...
            commands: ["df -h", "brew services restart clickhouse", "startcheck --config-dir Config --migrations-dir Migrations"]
        ),
        scenario(
            code: "OS-002",
            ...
            commands: ["startcheck --config-dir Config --migrations-dir Migrations", "backfill --config-dir Config --symbols all", "supervise --config-dir Config --with-backfill"]
        )
    ]
